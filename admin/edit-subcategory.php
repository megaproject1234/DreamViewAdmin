...
<div class="control-group">
<label class="control-label" for="basicinput" style="color:Black;">SubCategory Name</label>
<div class="controls">
<input type="text" placeholder="Enter category Name"  name="subcategory" value="<?php echo  htmlentities($row['subcategory']);?>" class="span8 tip" required>
	...
	<div class="control-group">
											<div class="controls">
												<button type="submit" name="submit" class="btn" style="background-color:black;color:white;">Update</button>
											</div>
										</div>
									</form>
							</div>
