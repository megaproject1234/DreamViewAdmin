...
<label class="control-label" for="basicinput" style="color:black;">Category</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput" style="color:black;">Sub Category</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput" style="color:black;">Product Name</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput" style="color:black;">Product Company</label>
<div class="controls">
<input type="text"    name="productCompany"  placeholder="Enter Product Comapny Name" class="span8 tip" required>
</div>
</div>
<div class="control-group">
<label class="control-label" for="basicinput" style="color:black;">Product Price Before Discount</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput" style="color:black;">Product Price After Discount(Selling Price)</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput" style="color:black;">Product Description</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput" style="color:black;">Product Shipping Charge</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput" style="color:black;">Product Availability</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput" style="color:black;">Product Image1</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput" style="color:black;">Product Image2</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput" style="color:black;">Product Image3</label>
<div class="controls">
<input type="file" name="productimage3"  class="span8 tip">
	...
	<div class="control-group">
											<div class="controls">
												<button type="submit" name="submit" class="btn" style="background-color:black;color:white;">Insert</button>
											</div>
										</div>
									</form>
							</div>
