...
<label class="control-label" for="basicinput" style="color:black;">Category Name</label>
<div class="controls">
...
<div class="control-group">
											<label class="control-label" for="basicinput" style="color:black;">Description</label>
											<div class="controls">
	...
	<div class="control-group">
											<div class="controls">
												<button type="submit" name="submit" class="btn" style="background-color:black;color:white;">Create</button>
											</div>
										</div>
									</form>
							</div>
