...
<h3 style="color:#3300CC;">DreamView Site</h3>
            </a>
        </div><!-- /.logo -->
     ...
     <div class="module-body m-t-20">
        ...
        <a href="#" class='active' style="background-color:#3300CC;"><i class="icon fa fa-facebook"></i></a>
        <a href="#"><i class="icon fa fa-twitter"></i></a>
        <a href="https://www.linkedin.com/in/tanaya-jadhav-a8440720a"><i class="icon fa fa-linkedin"></i></a>
        </div><!-- /.social-icons -->
    </div><!-- /.module-body -->
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <span><a href="#">DreamViewProject@gmail.com</a></span>
                </div>
            </li>
